...
public class FragmentViewRequests extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        iView = inflater.inflate(R.layout.fragment_view_requests, container, false);
        ...
        int year = Integer.parseInt(SessionData.userregisteredDate.substring(0, 4));
        int month = Integer.parseInt(SessionData.userregisteredDate.substring(5, 7));
        int day = Integer.parseInt(SessionData.userregisteredDate.substring(8, 10));
        ...
        spinnerStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (++check > 0) {
                    ...
                    ((TextView) spinnerStatus.getSelectedView()).setTextColor(getResources().getColor(R.color.colorPrimary));
